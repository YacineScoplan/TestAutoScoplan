...
Cliquer sur "est-ce le CMI"
    Sleep    10s
    Wait Until Page Contains Element    //*[@id="ccmiOptionsRow"]/div[1]/div[1]/label/span
    Click Element    //*[@id="ccmiOptionsRow"]/div[1]/div[1]/label/span

Choisir "le client n'a pas recours à un pret"
    Sleep    10s
    Wait Until Page Contains Element    //select[@id="hasLoanCcmi"]
    Select From List By Value    //select[@id="hasLoanCcmi"]    no

Selectionner "Signature Electronique en interne"
    Sleep    10s
    Wait Until Page Contains Element    //*[@id="addDocModalActionWrap"]/div[1]/div[2]/div[1]/div[3]/label/span
    Click Element    //*[@id="addDocModalActionWrap"]/div[1]/div[2]/div[1]/div[3]/label/span

Selectionner signataire en interne
    Sleep    10s
    Wait Until Page Contains Element    //select[@id="selectCompanyUserToSign"]
    Select From List By Value    //select[@id="selectCompanyUserToSign"]    34643
...
Choisir dossier "Contrat & avenants": Un menu avec la possibilite d'ecrire un message apparait
    ...
    Sleep    2s
    Wait Until Page Contains Element    //input[@id="project_file_folder_402"]
    Click Element    //input[@id="project_file_folder_402"]
...
Verification de la reception du doc dans le compte particulier: "Accueil"
    ...
    Sleep    10s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE2_Accueil.png
    Close Browser
...
Verification de la reception du doc dans le compte particulier: Onglet "Docs"
    ...
    Sleep    10s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE2_OngletDoc.png
    Sleep    10s
    Close Browser
...
Verification de la SE dans le mail
    ...
    Sleep    3s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE2_MAIL.png
