...
Verification de la reception du doc dans le compte particulier: "Accueil"
    ...
    Sleep    10s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE1_Accueil.png
    Close Browser
...
Verification de la reception du doc dans le compte particulier: Onglet "Docs"
    ...
    Sleep    10s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE1_OngletDoc.png
    Sleep    10s
    Close Browser
...
Verification de la SE dans le mail
    ...
    Sleep    3s
    Capture Page Screenshot    ${CURDIR}${/}Capture Yousign${/}CaptureTSE1_MAIL.png
