...
Cliquer sur "Avant projet": Un menu avec la possibilite d'ecrire un message apparait
    ...
    Wait Until Page Contains Element    //input[@id="project_file_folder_401"]
    Click Element    //input[@id="project_file_folder_401"]
